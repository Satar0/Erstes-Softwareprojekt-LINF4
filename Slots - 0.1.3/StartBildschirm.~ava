...
public class StartBildschirm extends Application {
  ...
  private final ImageView UnoIcon = new ImageView(Unoicon);
   ...
   private Pane Menu() {
        ...
        SlotsIcon.setFitWidth(1600);
        SlotsIcon.setFitHeight(900);
        ...
        SchachIcon.setFitWidth(1600);
        SchachIcon.setFitHeight(900);
        ...
        UnoIcon.setFitWidth(1600);
        UnoIcon.setFitHeight(900);
